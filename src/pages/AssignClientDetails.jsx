  ...
  const handleSubmit = async () => {
    try {
      ...
      const payload = {
        ...
        other_rate_type: (formData.otherRateType || 'Percentage').toLowerCase(),
        ...
        account_manager_commission_rate_type: (formData.accountManagerRateType || 'Percentage').toLowerCase(),
        ...
        business_development_manager_commission_rate_type: (formData.bdManagerRateType || 'Fixed').toLowerCase(),
        ...
        recruiter_rate_type: (formData.recruiterRateType || 'Percentage').toLowerCase(),
        invoice_to: formData.invoiceTo || 'Client',
        recurssive: formData.recursive ? 1 : 0,
        recurssive_month: formData.recursive ? 'all_months' : (formData.recursiveMonth || null),
      };

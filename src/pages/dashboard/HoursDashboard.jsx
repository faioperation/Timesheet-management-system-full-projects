    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            ...
            try {
                ...
                const response = await apiFetch(`/hours/dashboard-data?${params.toString()}`, { method: "GET" });
                if (response.ok) {
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="px-2 grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
                        {/* Hours Analysis Bar Chart - 60% Width */}
                        <div className="lg:col-span-3 bg-white rounded-[24px] shadow-sm border border-gray-100 p-8 flex flex-col">
                            ...
                            <div className="flex justify-center gap-10 mt-10">
                                <div className="flex items-center gap-3">
                                    <span className="text-[15px] font-bold text-[#374151]">Daily</span>
                                    <div className="w-4 h-4 bg-[#DDE2FF] rounded-md"></div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <span className="text-[15px] font-bold text-[#374151]">Extra</span>
                                    <div className="w-4 h-4 bg-[#60A5FA] rounded-md"></div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <span className="text-[15px] font-bold text-[#374151]">Vacation</span>
                                    <div className="w-4 h-4 bg-[#F87171] rounded-md"></div>
                                </div>
                            </div>
                        </div>

                        {/* Timesheet Breakdown Pie Chart - 40% Width */}

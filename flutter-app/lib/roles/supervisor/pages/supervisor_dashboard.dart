...
import 'package:timesheet_naresh/roles/supervisor/pages/supervisor_hours_page.dart';
...
class SuperVisorDashBoard extends StatefulWidget {
  ...
  const SuperVisorDashBoard({super.key, this.onPageChange});
          ...
          child: Column(
            ...
            children: [
              ...
              HeaderSection(
                ...
                onPressed: () {
                  // Show only Hours (exclude current Consultant page)
                  showMenu(
                    context: context,
                    ...
                    if (value == 'hours') {
                      if (widget.onPageChange != null) {
                        widget.onPageChange!(SupervisorHoursPage(onPageChange: widget.onPageChange));
                      } else {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const SupervisorHoursPage(),
                          ),
                        );
                      }
                    }
